...
from thin_tts.text.symbols2 import punctuation
from thin_tts.text.tone_sandhi import ToneSandhi
from thin_tts.text.zh_normalization.text_normlization import TextNormalizer
...
def _get_g2pw():
    ...
    if _g2pw_instance is not None:
        return _g2pw_instance
    from thin_tts.text.g2pw import G2PWPinyin
    parent_directory = os.path.dirname(current_file_path)
    _g2pw_instance = G2PWPinyin(
        model_dir=os.environ.get("g2pw_model_path", os.path.join(parent_directory, "G2PWModel")),
...
def _g2p(segments):
    ...
    if is_g2pw:
        ...
        g2pw_batch_results = _get_g2pw()._g2pw(batch_inputs) if batch_inputs else []
    ...
    for seg in processed_segments:
        ...
        if not is_g2pw:
            ...
            for word, pos in seg_cut:
                ...
                # 多音字消歧
                from thin_tts.text.g2pw import correct_pronunciation
