...
from thin_tts.models.eres2net.ERes2NetV2 import ERes2NetV2
from thin_tts.models.eres2net import kaldi as Kaldi


class SV:
    def __init__(self, device, is_half, sv_path: str):
